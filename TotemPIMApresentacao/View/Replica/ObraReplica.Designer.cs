namespace TotemPIMApresentacao.View
{
    partial class ObraReplica
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ObraReplica));
            label2 = new Label();
            ...
            label2.Name = "label2";
            label2.Size = new Size(452, 65);
            label2.TabIndex = 5;
            label2.Text = "RÉPLICA DA NAVE ";
            // 
            ...
            lblTextoObra.Font = new Font("Segoe UI", 12.75F, FontStyle.Bold, GraphicsUnit.Point);
            lblTextoObra.ForeColor = Color.White;
            lblTextoObra.Location = new Point(173, 302);
            lblTextoObra.Name = "lblTextoObra";
            lblTextoObra.Size = new Size(1025, 460);
