namespace TotemPIMApresentacao.View
{
    partial class ObraSuits
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ObraSuits));
            label2 = new Label();
            ...
            label2.Name = "label2";
            label2.Size = new Size(609, 86);
            label2.TabIndex = 5;
            label2.Text = "TRAJES ESPACIAIS ";
            // 
            ...
            lblTextoObra.Font = new Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point);
            lblTextoObra.ForeColor = Color.White;
            lblTextoObra.Location = new Point(173, 340);
            lblTextoObra.Name = "lblTextoObra";
            lblTextoObra.Size = new Size(926, 420);
